...
class AddGSecondModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    handleSubmit = e =>{
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                let params = '?cname='+cname+'&imgUrl='+imgUrl+'&pid='+pid+'&pname='+pname;
                this.props.addGoodsSecond(params);
    ...
    render() {
        ...
        const {visible,handleCancel,goodsFirst} = this.props;
...
const WrappedDynamicRule = Form.create({ name: 'dynamic_rule' })(AddGSecondModal);
